  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        {/* Overall Progress */}
        <div className="inline-flex items-center gap-4 bg-dark-800 rounded-lg px-6 py-3">
        ...
        {sections.map((section, index) => {
          ...
          return (
            <Link
              ...
              className="group bg-dark-800 rounded-xl p-6 border border-dark-700 hover:border-primary-500/50 transition-all duration-200"
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-dark-700 rounded-lg flex items-center justify-center text-2xl group-hover:bg-primary-500/20 transition-colors">
                  {section.icon}
                </div>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-dark-800/50 rounded-lg p-6 text-center">
          ...
          <h3 className="text-white font-medium mb-2">Python in Browser</h3>
        ...
        <div className="bg-dark-800/50 rounded-lg p-6 text-center">
          <div className="text-3xl mb-3">✅</div>
          <h3 className="text-white font-medium mb-2">Instant Feedback</h3>
          <p className="text-dark-400 text-sm">
